    ...
    for current_block in range(updated_block, new_block+1):
        ...
        if len(tx_list)!=0:
            ...
            for tx in tx_list:
                ...
                tx_insert['patientID']=parsed_data['to']
                tx_insert['hospitalID']=parsed_data['from']
                tx_insert['patientID']=parsed_data['emr']
                tx_insert['emrID']=parsed_data['emrID']
                tx_insert['time']=parsed_data['time']
